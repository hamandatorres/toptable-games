...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Board game categories';
...
export interface ApiDesignerDesigner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Board game designers';
...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Board game information';
    displayName: 'Game';
    pluralName: 'games';
    singularName: 'game';
  };
  ...
  attributes: {
    avgRating: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    bgg_id: Schema.Attribute.Integer & Schema.Attribute.Unique;
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    playtime_max: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 1440;
          min: 1;
        ...
        number
      >;
    playtime_min: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 1440;
          min: 1;
    ...
    >;
    thumb_url: Schema.Attribute.String;
    thumbnail: Schema.Attribute.Media<'images'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    year_published: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 2030;
          min: 1800;
...
export interface ApiMechanicMechanic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Board game mechanics';
...
export interface ApiPublisherPublisher extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Board game publishers';
