...
const PlayCountGraph: React.FC = () => {
  ...
  const userGames: UserGame[] = useSelector((state: RootState) => state.userGameReducer.userGames);
  ...
  const userGamesSorter = (userGames: UserGame[]): { userGamesLabels: string[]; userGamesPlays: number[] } => {
